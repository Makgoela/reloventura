            ...
            <form method="POST" action="">
              ...
              <div class="modal-body">
                ...
                <div class="modal-footer">
                  <button type="submit" name="book2" class="btn-pay-now  "><a href="api.php" class="text-light" style="text-decoration:none;">Pay Now</a></button>
    ...
    <script>
      $(document).ready(function() {
        ...
        function updateTotalPrice() {
          ...
          const totalPrice = (price * days * numPeople) + (cateringPrice * days * numPeople);
...
?>
<?php
include 'connection.php'; // Include the database connection at the beginning
if (isset($_POST["book"])) {
  // Retrieve form data
  ...
  $totalPrice = ($price * $days * $numPeople) + ($cateringPrice * $days * $numPeople);
  ...
  if ($stmt->execute()) {
    ...
    // Booking was successful, set a success message
